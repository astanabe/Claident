...
sh -c "BLASTDB=./ blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_cp_species_wsp_man.txt -seqid_title plants_cp_species_wsp_man -seqid_file_out plants_cp_species_wsp_man.bsl; BLASTDB=./ blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_cp_species_wsp_man.bsl -out plants_cp_species_wsp_man -title plants_cp_species_wsp_man" &
sh -c "BLASTDB=./ blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_cp_species_man.txt -seqid_title plants_cp_species_man -seqid_file_out plants_cp_species_man.bsl; BLASTDB=./ blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_cp_species_man.bsl -out plants_cp_species_man -title plants_cp_species_man" &
sh -c "BLASTDB=./ blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_cp_species_wosp_man.txt -seqid_title plants_cp_species_wosp_man -seqid_file_out plants_cp_species_wosp_man.bsl; BLASTDB=./ blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_cp_species_wosp_man.bsl -out plants_cp_species_wosp_man -title plants_cp_species_wosp_man" &
wait
cd .. || exit $?
# minimize taxdb
