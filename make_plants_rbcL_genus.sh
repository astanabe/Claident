...
clblastseq blastn -db `pwd`/blastdb/plants_genus -word_size 11 -evalue 1e-15 -strand plus -task blastn -max_target_seqs 10000000 end --output=ACCESSION --numthreads=$NCPU --hyperthreads=8 references_plants_rbcL.fasta plants_rbcL2.txt || exit $?
# eliminate duplicate entries
clelimdupacc plants_rbcL1.txt plants_rbcL2.txt plants_rbcL.txt || exit $?
# extract identified sequences
clretrieveacc --maxrank=genus --ngword='^x , x ,environmental,uncultured,unclassified,unidentified,metagenome,metagenomic' --acclist=plants_rbcL.txt --taxdb=plants.taxdb plants_rbcL_genus.txt &
...
clretrieveacc --maxrank=genus --ngword='^x , x ,environmental,uncultured,unclassified,unidentified,metagenome,metagenomic' --includetaxa=genus,.+ --acclist=plants_rbcL.txt --taxdb=plants.taxdb plants_rbcL_genus_man.txt &
...
wait
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_rbcL_genus.txt -seqid_title plants_rbcL_genus -seqid_file_out plants_rbcL_genus.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_rbcL_genus.bsl -out plants_rbcL_genus -title plants_rbcL_genus" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_rbcL_species_wsp.txt -seqid_title plants_rbcL_species_wsp -seqid_file_out plants_rbcL_species_wsp.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_rbcL_species_wsp.bsl -out plants_rbcL_species_wsp -title plants_rbcL_species_wsp" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_rbcL_species.txt -seqid_title plants_rbcL_species -seqid_file_out plants_rbcL_species.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_rbcL_species.bsl -out plants_rbcL_species -title plants_rbcL_species" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_rbcL_species_wosp.txt -seqid_title plants_rbcL_species_wosp -seqid_file_out plants_rbcL_species_wosp.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_rbcL_species_wosp.bsl -out plants_rbcL_species_wosp -title plants_rbcL_species_wosp" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_rbcL_genus_man.txt -seqid_title plants_rbcL_genus_man -seqid_file_out plants_rbcL_genus_man.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_rbcL_genus_man.bsl -out plants_rbcL_genus_man -title plants_rbcL_genus_man" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_rbcL_species_wsp_man.txt -seqid_title plants_rbcL_species_wsp_man -seqid_file_out plants_rbcL_species_wsp_man.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_rbcL_species_wsp_man.bsl -out plants_rbcL_species_wsp_man -title plants_rbcL_species_wsp_man" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_rbcL_species_man.txt -seqid_title plants_rbcL_species_man -seqid_file_out plants_rbcL_species_man.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_rbcL_species_man.bsl -out plants_rbcL_species_man -title plants_rbcL_species_man" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_rbcL_species_wosp_man.txt -seqid_title plants_rbcL_species_wosp_man -seqid_file_out plants_rbcL_species_wosp_man.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_rbcL_species_wosp_man.bsl -out plants_rbcL_species_wosp_man -title plants_rbcL_species_wosp_man" &
wait
cd .. || exit $?
# minimize taxdb
...
chmod 666 plants_rbcL_genus.taxdb || exit $?
