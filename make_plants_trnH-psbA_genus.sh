...
clretrieveacc --keywords='"ddbj embl genbank"[Filter] AND (txid33090[Organism:exp] AND 150:10000000[Sequence Length] AND ("trnH-psbA"[Title] OR ((trnH[Title] OR "tRNA-His"[Title]) AND psbA[Title])) NOT environmental[Title] NOT uncultured[Title] NOT unclassified[Title] NOT unidentified[Title] NOT metagenome[Title] NOT metagenomic[Title])' plants_trnH-psbA1.txt || exit $?
...
clblastseq blastn -db `pwd`/blastdb/plants_genus -word_size 11 -evalue 1e-15 -strand plus -task blastn -max_target_seqs 10000000 end --output=ACCESSION --numthreads=$NCPU --hyperthreads=8 references_plants_trnH-psbA.fasta plants_trnH-psbA2.txt || exit $?
# eliminate duplicate entries
clelimdupacc plants_trnH-psbA1.txt plants_trnH-psbA2.txt plants_trnH-psbA.txt || exit $?
# extract identified sequences
clretrieveacc --maxrank=genus --ngword='^x , x ,environmental,uncultured,unclassified,unidentified,metagenome,metagenomic' --acclist=plants_trnH-psbA.txt --taxdb=plants.taxdb plants_trnH-psbA_genus.txt &
...
clretrieveacc --maxrank=genus --ngword='^x , x ,environmental,uncultured,unclassified,unidentified,metagenome,metagenomic' --includetaxa=genus,.+ --acclist=plants_trnH-psbA.txt --taxdb=plants.taxdb plants_trnH-psbA_genus_man.txt &
...
wait
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_trnH-psbA_genus.txt -seqid_title plants_trnH-psbA_genus -seqid_file_out plants_trnH-psbA_genus.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_trnH-psbA_genus.bsl -out plants_trnH-psbA_genus -title plants_trnH-psbA_genus" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_trnH-psbA_species_wsp.txt -seqid_title plants_trnH-psbA_species_wsp -seqid_file_out plants_trnH-psbA_species_wsp.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_trnH-psbA_species_wsp.bsl -out plants_trnH-psbA_species_wsp -title plants_trnH-psbA_species_wsp" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_trnH-psbA_species.txt -seqid_title plants_trnH-psbA_species -seqid_file_out plants_trnH-psbA_species.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_trnH-psbA_species.bsl -out plants_trnH-psbA_species -title plants_trnH-psbA_species" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_trnH-psbA_species_wosp.txt -seqid_title plants_trnH-psbA_species_wosp -seqid_file_out plants_trnH-psbA_species_wosp.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_trnH-psbA_species_wosp.bsl -out plants_trnH-psbA_species_wosp -title plants_trnH-psbA_species_wosp" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_trnH-psbA_genus_man.txt -seqid_title plants_trnH-psbA_genus_man -seqid_file_out plants_trnH-psbA_genus_man.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_trnH-psbA_genus_man.bsl -out plants_trnH-psbA_genus_man -title plants_trnH-psbA_genus_man" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_trnH-psbA_species_wsp_man.txt -seqid_title plants_trnH-psbA_species_wsp_man -seqid_file_out plants_trnH-psbA_species_wsp_man.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_trnH-psbA_species_wsp_man.bsl -out plants_trnH-psbA_species_wsp_man -title plants_trnH-psbA_species_wsp_man" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_trnH-psbA_species_man.txt -seqid_title plants_trnH-psbA_species_man -seqid_file_out plants_trnH-psbA_species_man.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_trnH-psbA_species_man.bsl -out plants_trnH-psbA_species_man -title plants_trnH-psbA_species_man" &
sh -c "BLASTDB=`pwd` blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in plants_trnH-psbA_species_wosp_man.txt -seqid_title plants_trnH-psbA_species_wosp_man -seqid_file_out plants_trnH-psbA_species_wosp_man.bsl; BLASTDB=`pwd` blastdb_aliastool -dbtype nucl -db overall_class -seqidlist plants_trnH-psbA_species_wosp_man.bsl -out plants_trnH-psbA_species_wosp_man -title plants_trnH-psbA_species_wosp_man" &
wait
cd .. || exit $?
# minimize taxdb
