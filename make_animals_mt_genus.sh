...
clextractdupgi --workspace=disk overall_underclass.txt ../animals_mt_genus.txt animals_mt_genus.txt &
clextractdupgi --workspace=disk overall_underclass.txt ../animals_mt_species.txt animals_mt_species.txt &
wait
blastdb_aliastool -dbtype nucl -db ./overall_class -gilist animals_mt_genus.txt -out animals_mt_genus -title animals_mt_genus &
blastdb_aliastool -dbtype nucl -db ./overall_class -gilist animals_mt_species.txt -out animals_mt_species -title animals_mt_species &
wait
cd .. || exit $?
# minimize taxdb
