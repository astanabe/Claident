...
clretrieveacc --maxrank=genus --additional=enable --ngword='^x , x ,environmental,uncultured,unclassified,unidentified,metagenome,metagenomic' --includetaxa=genus,.+ --acclist=fungi_ITS.txt --taxdb=fungi.taxdb fungi_ITS_genus_man.txt &
...
sh -c "BLASTDB=./ blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in fungi_ITS_genus_man.txt -seqid_title fungi_ITS_genus_man -seqid_file_out fungi_ITS_genus_man.bsl; BLASTDB=./ blastdb_aliastool -dbtype nucl -db overall_class -seqidlist fungi_ITS_genus_man.bsl -out fungi_ITS_genus_man -title fungi_ITS_genus_man" &
sh -c "BLASTDB=./ blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in fungi_ITS_species_wsp_man.txt -seqid_title fungi_ITS_species_wsp_man -seqid_file_out fungi_ITS_species_wsp_man.bsl; BLASTDB=./ blastdb_aliastool -dbtype nucl -db overall_class -seqidlist fungi_ITS_species_wsp_man.bsl -out fungi_ITS_species_wsp_man -title fungi_ITS_species_wsp_man" &
sh -c "BLASTDB=./ blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in fungi_ITS_species_man.txt -seqid_title fungi_ITS_species_man -seqid_file_out fungi_ITS_species_man.bsl; BLASTDB=./ blastdb_aliastool -dbtype nucl -db overall_class -seqidlist fungi_ITS_species_man.bsl -out fungi_ITS_species_man -title fungi_ITS_species_man" &
sh -c "BLASTDB=./ blastdb_aliastool -seqid_dbtype nucl -seqid_db overall_class -seqid_file_in fungi_ITS_species_wosp_man.txt -seqid_title fungi_ITS_species_wosp_man -seqid_file_out fungi_ITS_species_wosp_man.bsl; BLASTDB=./ blastdb_aliastool -dbtype nucl -db overall_class -seqidlist fungi_ITS_species_wosp_man.bsl -out fungi_ITS_species_wosp_man -title fungi_ITS_species_wosp_man" &
wait
cd .. || exit $?
# minimize taxdb
